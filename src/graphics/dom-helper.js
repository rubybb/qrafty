	...
	domHelper: {
		...
		translate: function (clientX, clientY, layer, out) {
			...
			if (layer) {
				...
				out.x = (clientX - Qrafty.stage.x + (doc && doc.scrollLeft || body && body.scrollLeft || 0)) / view._scale + view._x;
				out.y = (clientY - Qrafty.stage.y + (doc && doc.scrollTop || body && body.scrollTop || 0)) / view._scale + view._y;
			} else {
