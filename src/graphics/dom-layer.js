 ...
 */
Qrafty._registerLayerTemplate("DOM", {
	type: "DOM",
	...
	layerInit: function () {
		...
		Qrafty.stage.elem.appendChild(div);
	...
	_setPixelArt: function(enabled) {
		...
		var camelize = Qrafty.domHelper.camelize;
		if (enabled) {
	...
	_setViewport: function() {
		...
		style.transform = style[Qrafty.support.prefix + "Transform"] = "scale(" + scale + ", " + scale + ")";
