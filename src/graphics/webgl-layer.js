 ...
 */
Qrafty._registerLayerTemplate("WebGL", {
	type: "WebGL",
	...
	layerInit: function() {
		...
		if (!Qrafty.support.webgl) {
			Qrafty.trigger("NoWebGL");
			Qrafty.stop();
			return;
		}
		...
		this.texture_manager = new Qrafty.TextureManager(gl, this);
