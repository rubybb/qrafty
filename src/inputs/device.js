...
Qrafty.extend({
	...
	device: {
		...
		_normalizeDeviceOrientation: function (eventData) {
			...
			Qrafty.device._deviceOrientationCallback(data);
		},
		...
		_normalizeDeviceMotion: function (eventData) {
			...
			Qrafty.device._deviceMotionCallback(data);
		},
		...
		deviceOrientation: function (func) {
			...
			if (Qrafty.support.deviceorientation) {
				if (window.DeviceOrientationEvent) {
					// Listen for the deviceorientation event and handle DeviceOrientationEvent object
					Qrafty.addEvent(this, window, "deviceorientation", this._normalizeDeviceOrientation);
				} else if (window.OrientationEvent) {
					// Listen for the MozOrientation event and handle OrientationData object
					Qrafty.addEvent(this, window, "MozOrientation", this._normalizeDeviceOrientation);
				}
			}
		},
		...
		deviceMotion: function (func) {
			...
			if (Qrafty.support.devicemotion) {
				if (window.DeviceMotionEvent) {
					// Listen for the devicemotion event and handle DeviceMotionEvent object
					Qrafty.addEvent(this, window, "devicemotion", this._normalizeDeviceMotion);
				}
			}
		}
	}
