...
Qrafty.extend({
	...
	_touchDispatch: (function () {
		...
		return function(e) {
			...
			if (Qrafty._multitouch) {
				if (!touchSystem) touchSystem = Qrafty.s("Touch");
 ...
 */
Qrafty.s("Touch", Qrafty.extend.call(Qrafty.extend.call(new Qrafty.__eventDispatcher(), {
	normedEventNames: {
	...
	prepareEvent: function (e, type) {
		...
		evt.target = this.touchObjs ? Qrafty.findPointerEventTargetByComponent("Touch", e) : null;
